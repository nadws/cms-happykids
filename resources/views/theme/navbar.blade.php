...
<div class="container-fluid sticky-top shadow-sm warna1" style="background-color: {{ $warna }}">
    <div class="container">
        <nav class="navbar warna1 navbar-expand-lg navbar-light py-3 py-lg-0"
            ...
            <a href="#" data-bs-toggle="modal" data-bs-target="#edit-h1" class="navbar-brand">
                <h1 data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip"
                    data-bs-title="teks logo" class="m-0 text-uppercase border border-5 fwarna1 border-a"
                    style="color: {{ $fontc1 }};">
                    <img data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip"
                        data-bs-title="logo navbar" src="{{ asset('assets/img/' . $img . '') }}" width="100"
                        height="80" alt="">
                    {{ $h1 }}
                </h1>
            </a>

            <a href="#" data-bs-toggle="modal" data-bs-target="#edit-theme" class="text-secondary"><i
                    class="bi bi-pencil-square"></i> Theme Colors</a>
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    <a href="#" class="nav-item nav-link fwarna1"
                        style="font-size: 15px;color: {{ $fontc1 }};">Beranda</a>
                    <a href="#load-about" class="nav-item nav-link fwarna1"
                        style="font-size: 15px;color: {{ $fontc1 }};">Tentang Kami</a>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <img src="{{ asset('assets/img/' . $img . '') }}" width="100" height="80"><span
                            class="text-warning ml-3">Dimensions : 500 x 500</span>
                ...
                <div class="modal-body">
                    <center>
                        ...
                        <div class="row mt-5">
                            <h5>Font Colors</h5>
                            <div class="col-lg-4">
                                <input class="form-control style1" id="fwarna1" type="color"
                                    value="{{ $fontc1 }}" name="fontc1">
                                <label for="" class="text-secondary ml-2">Font Besar</label>
                            </div>
                            <div class="col-lg-4">
                                <input class="form-control style1" id="fwarna2" type="color"
                                    value="{{ $fontc2 }}" name="fontc2">
                                <label for="" class="text-secondary ml-2">Font Sedang</label>
                            </div>
                            <div class="col-lg-4">
                                <input class="form-control style1" id="fwarna3" type="color"
                                    value="{{ $fontc3 }}" name="fontc3">
