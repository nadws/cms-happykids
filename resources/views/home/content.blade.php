...
@section('content')
    ...
    <!-- Hero Start -->
    <div id="load-home" class="container-fluid py-5 mb-5"
        style="background: url(assets/img/{{ $img_hero }}) top right no-repeat; background-size: cover;height: 650px;">
        <div class="container py-5" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip"
            data-bs-title="Gambar Hero">
            <div class="row justify-content-start">
                <div data-bs-toggle="modal" data-bs-target="#edit-hero-text"
                    class="col-lg-8 text-center text-lg-start border border-a border-5" style="padding: 3px">
            ...
            "
                    ...
                    <h1 data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <img class="mb-3" src="{{ asset('assets/img/' . $img_hero . '') }}" width="150"
                                height="100"><span class="text-warning ml-3">Dimensions : 1920 x 1080</span>
                ...
                <div class="col-lg-5 mb-5 mb-lg-0" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip"
                            data-bs-title="Gambar Tentang" class="position-absolute w-100 h-100 rounded"
                            src="{{ asset('assets') }}/img/{{ $img_tentang }}" style="object-fit: cover" />
                    </div>
                </div>
                <div class="col-lg-7">
                    ...
                    <p data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip"
                    ...
                    <div class="row g-3 pt-1">
                        <div class="col-sm-6 col-12">
                            ...
                            <iframe data-bs-toggle="tooltip" data-bs-placement="top"
                                data-bs-custom-class="custom-tooltip" data-bs-title="maps"
                                class="position-relative w-100 h-100" src="{{ $maps }}" frameborder="0"
                                style="border: 0" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>

                        </div>
                        <div class="col-sm-6 col-12">
                            <h5 style="color: {{ $fontc2 }}"
                                class="fwarna2 d-inline-block text-uppercase border-bottom border-5">
                                Hubungi Kami
                            </h5>
                            <table class="table tbl-hub fwarna2" style="color:{{ $fontc2 }}">
                                <center>
                                    <tr data-bs-toggle="tooltip" data-bs-placement="top"
                                        data-bs-custom-class="custom-tooltip" data-bs-title="Waktu">
                                        <th>
                                    ...
                                    <tr data-bs-toggle="tooltip" data-bs-placement="top"
                                        data-bs-custom-class="custom-tooltip" data-bs-title="Alamat">
                                        <th>
                                    ...
                                    <tr data-bs-toggle="tooltip" data-bs-placement="top"
                                        data-bs-custom-class="custom-tooltip" data-bs-title="No HP">
                                        <th>
                                    ...
                                    <tr data-bs-toggle="tooltip" data-bs-placement="top"
                                        data-bs-custom-class="custom-tooltip" data-bs-title="Email">
                                        <th>
    ...
    <form action="{{ route('save_tentang') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="modal" id="edit-tentang-text" role="dialog" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
                        ...
                        <div class="row">
                            <div class="col-6 col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <img class="mb-3" src="{{ asset('assets/img/' . $img_tentang . '') }}"
                                        width="150" height="100"> <span class="text-warning ml-3">Dimensions : 800 x
                                        500</span>
                                    <input type="file" class="form-control" name="img_tentang">
                                </div>
                                <div class="form-group">
                                    <label for="">Teks 1</label>
                                    <input value="{{ $teks_tentang1 }}" type="text" name="teks_tentang1"
                                        class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="">Teks 2</label>
                            ...
                            <div class="col-6 col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input value="{{ $waktu }}" type="text" name="waktu"
                                        class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="">Alamat</label>
                                    <input value="{{ $alamat }}" type="text" name="alamat"
                                        class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="">No HP</label>
                                    <input value="{{ $nohp }}" type="text" name="nohp"
                                        class="form-control">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input value="{{ $instagram }}" type="text" name="instagram"
                                        class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="">Maps</label>
                                    <input value="{{ $maps }}" type="text" class="form-control"
                                        name="maps">
    ...
    <!-- Appointment Start -->
    <div id="load-appointment" class="container-fluid my-5 py-5 warna1" style="background-color: {{ $warna }}">
        <div class="container py-5">
            <div class="row gx-5">
                <div class="col-lg-4 mb-5 mb-lg-0">
                    <img style="object-fit: cover" class="w-100 h-50 rounded"
                        src="{{ asset('assets') }}/img/{{ $img }}" alt="">
                    <img style="object-fit: cover;" class="w-100 h-50 rounded mt-3"
                        src="{{ asset('assets') }}/img/{{ $img_tamu }}" alt="">
                </div>
                <div class="col-lg-8">
                    <div class="bg-white rounded p-5 border border-a border-5" style="padding: 3px"
                        data-bs-toggle="modal" data-bs-target="#edit-tamu-selesai-text">
                        <h3 class="mb-4 text-center" data-bs-toggle="tooltip" data-bs-placement="top"
                            data-bs-custom-class="custom-tooltip" data-bs-title="teks 1">{{ $teks_janji1 }}</h3>
                        <p style="color: #34364A" data-bs-toggle="tooltip" data-bs-placement="top"
                            data-bs-custom-class="custom-tooltip" data-bs-title="Teks 2">{{ $teks_janji2 }}</p>

                        <h5 style="text-align: left">Detail Pembayaran</h5>
                        <table width="40%">
                            <tr>
                                <td data-bs-toggle="tooltip" data-bs-placement="top"
                                    data-bs-custom-class="custom-tooltip" data-bs-title="nominal appointment"
                                    style="text-align: left">Appointment: </td>
                  ...
                  <th data-bs-toggle="tooltip" data-bs-placement="top"
                    ...
                    data-bs-title="nominal transfer" style="text-align: right;color: #34364A">{{ number_format($nominal_tf,0) }}</th>
                        ...
                        <table data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip"
                            data-bs-title="Admin & No Whatsapp" width="50%">
                            <tr>
                                <td><a target="_blank"
                                        href="https://wa.me/{{ $wa_nohp }}?text=SILAHKAN%20UPLOAD%20BUKTI%20TRANSFER%0ANo%20Order%20:%20%20%0Aemail%20:%20%20%0AProvinsi:%20%0AKota:"
                                        class="btn btn-secondary"> <svg xmlns="http://www.w3.org/2000/svg" x="0px"
    ...
    <form action="{{ route('save_teks_tamu') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="modal" id="edit-tamu-selesai-text" role="dialog" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-primary">
                    ...
                    <div class="modal-body">
                        <center>
                            <div class="row">
                                <div class="col-lg-6">
                                    <img style="object-fit: cover" src="{{ asset('assets') }}/img/{{ $img_tamu }}"
                                        class="pb-3" width="200" height="200" alt="">
                                    <input type="file" class="form-control" name="img_tentang">
                                </div>
                            </div>
                        </center>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nominal_app" value="{{ $nominal_app }}"
                                        class="form-control">
                                </div>
                            </div>
                            {{-- <div class="col-lg-6">
                  <div class="form-group">
                      ...
                      <input type="text" name="nominal_tf" value="{{ $nominal_tf }}" class="form-control">
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <img src="{{ asset('assets') }}/img/logo_bank_mandiri.png" alt=""
                                        width="90px">
                                    <label for="">Admin</label>
                                    <input type="text" name="mandiri_admin" value="{{ $mandiri_admin }}"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="col-lg-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="mandiri_norek" value="{{ $mandiri_norek }}"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <img src="{{ asset('assets') }}/img/logo_bank_bca.png" alt=""
                                        width="90px">
                                    <label for="">Admin</label>
                                    <input type="text" name="bca_admin" value="{{ $bca_admin }}"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="col-lg-3">
                                ...
                                <div class="form-group">
                                    <img src="{{ asset('assets') }}/img/logo_bank_bca.png" alt=""
                                        width="90px">
                                    <label for="">No Rek</label>
                                    <input type="text" name="bca_norek" value="{{ $bca_norek }}"
                                        class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="wa_admin" value="{{ $wa_admin }}"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="wa_nohp" value="{{ $wa_nohp }}"
                                        class="form-control">
                                </div>
                            </div>
                        </div>
